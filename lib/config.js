  ...
  IS_TEXTFORMAT_ENABLED: {
    get: function() {
      if (store.IS_TEXTFORMAT_ENABLED == null) {
        store.IS_TEXTFORMAT_ENABLED = getEnvOpt('LOGOLITE_TEXTFORMAT_ENABLED') === 'true';
        if (store.IS_TEXTFORMAT_ENABLED !== true) {
          if (getEnvOpt('LOGOLITE_TEXTFORMAT_ENABLED') !== 'false') {
            store.IS_TEXTFORMAT_ENABLED = !(getEnvOpt('DEBUG') == undefined);
          }
        }
      }
